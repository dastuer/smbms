...
<div class="container">
    ...
    <form action="./updateBook" method="post" enctype="multipart/form-data" onsubmit="return checkType()">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="number" name="bookCount" value="${book.bookCount}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="cover" name="file" value="${book.cover}" type="file">
        </div>
        <input name="bookID" value="${book.bookID}" type="hidden">
        <button type="submit" class="btn btn-default">提交修改</button>
        <a class="btn btn-default" href="${pageContext.request.contextPath}/book/allBooks" onclick="return quit()">返回</a>
    </form>
</div>
</body>
</html>
